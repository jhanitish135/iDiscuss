  ...
  <ul class="navbar-nav mr-auto">
    ...
    <li class="nav-item dropdown">
      ...
      <div class="dropdown-menu" aria-labelledby="navbarDropdown">';
        ...
        echo '<a class="dropdown-item" href="threadlist.php?catid='.$cat_id.'">'.$cat.'</a>';
  ...
  if(isset($_SESSION['loggedin']) && $_SESSION['loggedin']==true ){
    echo '<form class="form-inline my-2 my-lg-0" action="/forum/search.php" method="get">
      ...
      echo '<form class="form-inline my-2 my-lg-0">
         ...
         <button class="btn btn-outline-danger mx-2" data-toggle="modal" data-target="#signupModal">Signup</button>
   ';
  }
